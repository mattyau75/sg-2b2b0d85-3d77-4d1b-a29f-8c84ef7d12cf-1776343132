          ...
          <div className="p-6 md:p-10">
            <DialogHeader className="mb-8">
              <div className="flex items-center gap-4 mb-2">
                ...
                <div>
                  <DialogTitle className="text-3xl font-black uppercase italic tracking-tighter text-white">Initialize Game Analysis</DialogTitle>
                  <DialogDescription className="text-muted-foreground font-mono text-xs uppercase tracking-widest mt-1">
                    Deploy AI sensors and calibrate team rosters for elite tracking.
                  </DialogDescription>
                </div>
              </div>
            </DialogHeader>
